...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AGENT_SKILL_MAX_COUNT": {
        "title": "Max Strategy Selection",
        "description": "Maximum number of strategies/skills that can be selected in the stock query chat.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "input",
        "is_sensitive": False,
        ...
        "display_order": 70,
        "help_key": "settings.agent.AGENT_SKILL_MAX_COUNT",
        "examples": [
            "AGENT_SKILL_MAX_COUNT=3",
            "AGENT_SKILL_MAX_COUNT=5",
        ],
        "docs": [],
        "warning_codes": [],
    },
